...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        $checkQuery = "SELECT COUNT(*) as count FROM clients WHERE email='$email' AND id!=$id";
        ...
        $sql = "UPDATE clients " .
                "SET block = '$block', lot = '$lot', name = '$name', email = '$email', phone = '$phone',
                previous = '$previous', present = '$present', consumption = '$consumption', amount = '$amount',
                unpaid = '$unpaid', total = '$total', remarks = '$remarks' " .
                "WHERE id = $id";
